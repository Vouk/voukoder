	...
	encoders(encoders)
{
	...
	wxStaticBoxSizer* sbPresetsSizer = new wxStaticBoxSizer(new wxStaticBox(m_presetsPanel, wxID_ANY, Trans("ui.voukoder.configuration.encoder.preset")), wxVERTICAL);
