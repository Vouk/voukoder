	...
	exportInfo(exportInfo)
{
	...
	m_generalLogText = new wxTextCtrl(m_generalLogPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_MULTILINE | wxTE_READONLY | wxHSCROLL | wxTE_RICH2);
